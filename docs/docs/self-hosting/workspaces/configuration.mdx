...
2. Consolidates all resources back to the `default` workspace
3. Removes workspace columns and reverts indexes

Rollback will fail if consolidation would create naming conflicts.
...
- [Workspace Providers](./workspace-providers) - Learn about pluggable providers
- [Permissions](./permissions) - Configure fine-grained access control
