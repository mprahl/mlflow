...
class WorkspaceProvider(ABC):
    ...
    def resolve_artifact_root(
        self, default_artifact_root: str, workspace_name: str = None
    ) -> tuple[str, bool]:
...
- [Permissions](./permissions) - Configure workspace-scoped permissions
- [Getting Started](./getting-started) - Set up your first workspace
