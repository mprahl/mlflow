...
def _resolve_default_workspace_name() -> str | None:
    ...
    workspace, _ = get_default_workspace_optional(workspace_store, request, logger=_logger)
...
def _is_proxy_artifact_path(path: str) -> bool:
    prefixes = [
        ...
        f"{_REST_API_PATH_PREFIX}/mlflow-artifacts/workspaces/",
        f"{_AJAX_API_PATH_PREFIX}/mlflow-artifacts/artifacts",
        f"{_AJAX_API_PATH_PREFIX}/mlflow-artifacts/workspaces/",
    ]
