...
def upgrade():
    ...
    with _with_batch("experiments") as batch_op:
        batch_op.create_unique_constraint("uq_experiments_workspace_name", ["workspace", "name"])
    ...
    # on `experiments` and `registered_models` so legacy clients that are unaware of
