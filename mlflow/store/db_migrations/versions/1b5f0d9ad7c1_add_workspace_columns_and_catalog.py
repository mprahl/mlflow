...
def upgrade():
    ...
    # MySQL-specific fix: Ensure webhooks.workspace retains its default after index creation
    # MySQL can drop column defaults during certain ALTER TABLE operations
