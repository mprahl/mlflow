...
class MlflowClient:
    ...
    def __init__(
        ...
        self._workspace_client_error = None
    ...
    def _get_workspace_client(self) -> WorkspaceProviderClient:
        ...
        if self._workspace_client_error is not None:
            raise MlflowException(
                "Workspace operations are not available for this client. "
                "Configure a supported workspace store URI to use workspace APIs.",
                error_code=FEATURE_DISABLED,
            ) from self._workspace_client_error

        if self._workspace_uri is None:
            raise MlflowException(
                "Workspace URI resolution failed. Please configure a workspace store URI.",
        ...
        try:
            ...
            self._workspace_client_error = exc
            raise MlflowException(
