...
@click.option(
    ...
    metavar="URI",
    default=MLFLOW_WORKSPACE_URI.get(),
    help=(
...
@click.option(
    ...
    default=MLFLOW_ENABLE_WORKSPACES.get(),
    show_default=True,
    help="Enable experimental workspace support (multi-tenancy).",
)
def server(
    ctx,
    backend_store_uri,
    ...
    MLFLOW_ENABLE_WORKSPACES.set(bool(enable_workspaces))
