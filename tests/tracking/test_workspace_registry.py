...
def test_get_workspace_store_resolves_sqlalchemy(tmp_path):
    ...
    store = get_workspace_store(workspace_uri=workspace_uri, tracking_uri=workspace_uri)
...
def test_get_workspace_store_resolves_rest():
    store = get_workspace_store(
        workspace_uri="http://example.com",
...
def test_get_workspace_store_unsupported_scheme():
    with pytest.raises(
        ...
        get_workspace_store(
            workspace_uri="foo://workspace",
            tracking_uri="foo://workspace",
        )
